// premiumpro.component.ts

import { Component, ElementRef, OnInit } from '@angular/core';

@Component({
  selector: 'app-premiumpro',
  templateUrl: './premiumpro.component.html',
  styleUrls: ['./premiumpro.component.css']
})
export class PremiumproComponent implements OnInit {
  totalAnual!: number;
  tarjeta: any;
  ...
  calcularTotalAnual() {
    ...
    // Supongamos que hay un descuento de 3 meses
    const descuentoMeses = 3;
  
    // Calcula la cantidad de meses que se pagarán después del descuento
    const mesesConDescuento = 12 - descuentoMeses;
  
    // Calcula el total anual con descuento
    this.totalAnual = mensualidadIndividual * mesesConDescuento;
  }
