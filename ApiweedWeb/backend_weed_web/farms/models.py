...
class Farm(models.Model):
    ...
    longitude = models.DecimalField(null = False, blank = False, max_digits=9, decimal_places=30)
    latitude = models.DecimalField(null = False, blank = False, max_digits=9, decimal_places=30)
