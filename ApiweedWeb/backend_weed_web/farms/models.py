...
class Farm(models.Model):
    ...
    longitude = models.DecimalField(null = False, blank = False, max_digits=30, decimal_places=9)
    latitude = models.DecimalField(null = False, blank = False, max_digits=30, decimal_places=9)
